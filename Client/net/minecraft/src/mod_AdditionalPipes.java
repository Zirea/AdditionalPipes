...
public class mod_AdditionalPipes extends NetworkMod {
	...
	public String getVersion() {
		...
		return "3.1.0 (Minecraft 1.2.5, Buildcraft 3.1.5, Forge 3.1.3.103)";
	}
	...
	public static boolean allowWPRemove = false; // Remove
													// waterproofing/redstone
	...
	public void modsLoaded() {
		...
		if (loadLiquidsTeleport) {
			...
			craftingmanager.addRecipe(new ItemStack(pipeLiquidTeleport, 1), new Object[] { "w", "P", Character.valueOf('w'), BuildCraftTransport.pipeWaterproof, Character.valueOf('P'),
					pipeItemTeleport });
		}
		...
		if (loadItemsDistributor) {
			...
			craftingmanager.addRecipe(new ItemStack(pipeDistributor, 8),
					new Object[] { " r ", "IgI", Character.valueOf('r'), Item.redstone, Character.valueOf('I'), Item.ingotIron, Character.valueOf('g'), Block.glass });
		}
		...
		if (loadItemsAdvancedWood) {
			...
			craftingmanager.addRecipe(new ItemStack(pipeAdvancedWood, 8),
					new Object[] { " r ", "WgW", Character.valueOf('r'), Item.redstone, Character.valueOf('W'), Block.planks, Character.valueOf('g'), Block.glass });
		}
		...
		if (loadItemsAdvancedInsertion) {
			...
			craftingmanager.addRecipe(new ItemStack(pipeAdvancedInsertion, 8),
					new Object[] { " r ", "SgS", Character.valueOf('r'), Item.redstone, Character.valueOf('S'), Block.stone, Character.valueOf('g'), Block.glass });
		}
		...
		if (loadLiquidsRedstone) {
			...
			craftingmanager
					.addRecipe(new ItemStack(pipeRedStoneLiquid, 1), new Object[] { "w", "P", Character.valueOf('w'), BuildCraftTransport.pipeWaterproof, Character.valueOf('P'), pipeRedStone });
		}
		...
		if (Craftable) {
			CraftingManager.getInstance().addRecipe(new ItemStack(blockChunkLoader, 4),
					new Object[] { "iii", "iLi", "iii", Character.valueOf('i'), Item.ingotIron, Character.valueOf('L'), new ItemStack(Item.dyePowder, 1, 4) });
		}
