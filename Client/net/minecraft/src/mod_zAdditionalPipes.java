...
public class mod_zAdditionalPipes extends BaseModMp {
    ...
    public String getVersion() {
        return "3.0.1 (Minecraft 1.2.3, Buildcraft 3.1.4, Forge 1.4.1.59)";
    }
...
//	public static String MASTER_OVERRIDE_FILE = "/net/minecraft/src/buildcraft/zeldo/gui/block_textures_override.png";
    ...
    public static byte GUI_ITEM_SEND = 104;
    public static byte GUI_LIQUID_SEND = 105;
    public static byte GUI_ENERGY_SEND = 106;
    public static byte GUI_ADVANCEDWOOD_SEND = 107;
    public static byte GUI_ITEM_REC = 104;
    public static byte GUI_LIQUID_REC = 105;
    public static byte GUI_ENERGY_REC = 106;
    public static byte GUI_ADVANCEDWOOD_REC = 107;
    //Main Packet ID's
    ...
    public KeyBinding laserKeyBinding = new KeyBinding("key_lasers", 67); //F9
    public static List<Box> lasers = new LinkedList<>();

    @Override
    public void keyboardEvent(KeyBinding keybinding) {

        if (keybinding == this.laserKeyBinding) {
            toggleLasers();
        }
    }
    ...
    public mod_zAdditionalPipes() {
        ...
        ModLoader.registerKey(this, this.laserKeyBinding, false);
    ...
    public void modsLoaded() {
        ...
        System.out.println("Teleport Pipe Power Loss Configuration: " + PowerLossCfg);
