...
public class GuiButtonShorter extends GuiButton {
	...
	public void drawButton(Minecraft minecraft, int i, int j) {
		...
		drawTexturedModalRect(xPosition, yPosition, 0, 46 + k * 20, width / 2, height / 2);// top
																							// left
		drawTexturedModalRect(xPosition + width / 2, yPosition, 200 - width / 2, 46 + k * 20, width / 2, height / 2);// top
																														// right
		drawTexturedModalRect(xPosition, yPosition + height / 2, 0, 46 + k * 20 + 20 - height / 2, width / 2, height / 2);// bottom
																															// left
		drawTexturedModalRect(xPosition + width / 2, yPosition + height / 2, 200 - width / 2, 46 + k * 20 + 20 - height / 2, width / 2, height / 2);// bottom
																																					// right
